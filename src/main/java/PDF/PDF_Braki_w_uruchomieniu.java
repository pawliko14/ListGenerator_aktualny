...
public class PDF_Braki_w_uruchomieniu {
	...
	public static void create() throws SQLException{
		...
		/*
		 * lista ze wszystkimi pozycjami, kt�re GTT nie potrafi po��czy� z zam�wieniami
		 * BRAKI - BRAK URUCHOMIENIA / ZAM�WIENIA
		 */
		System.out.println("Start lista brak�w");
		...
		Document Braki = new Document(PageSize.A4, 10, 10, 25, 25);
			...
			Braki.close();
			myConn.close();
			System.out.println("Koniec listy brak�w");
	}
	private static void addHeader(PdfPTable t){
		String [] header = new String [] {"Numer serii", "Op�nienie", "Numer artyku�u", "Nazwa artyku�u", "Projekt", "Ilosc"};
	...
	private static void addProjectHeader(String [] dane, PdfPTable t){
		String [] header = new String[] {"Numer projektu", "Nazwa projektu", "Klient", "Data produkcji", "Data ko�ca monta�u"};
